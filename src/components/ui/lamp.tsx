  ...
  return (
    <LampContainer>
      <motion.div
        ...
        className="bg-black py-4 bg-clip-text text-center text-4xl font-medium tracking-tight text-transparent md:text-7xl"
      >
        <Typography
          variant="h1"
          sx={{
        ...
        >
          Transformasi Bisnismu <br /> Menggunakan{' '}
          <Typography
            variant="h1"
            component="span"
            sx={{
        ...
        <ShinyButton>Hubungi Kami</ShinyButton>
      </motion.div>
    </LampContainer>
  );
}
...
export const LampContainer = ({ children, className }: { children: React.ReactNode; className?: string }) => {
  return (
    <div
      className={cn('relative flex min-h-screen flex-col items-center justify-center overflow-hidden  w-full rounded-md z-0', className)}
    >
